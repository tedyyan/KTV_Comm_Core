...
ReceiveCharFunc CSerialPort::m_OnReceiveChar = NULL;
...
//
BOOL CSerialPort::InitPort( ReceiveCharFunc pOnReceiveChar, 	// the owner (CWnd) of the port (receives message)
						   ...
						   UINT  writebuffersize)	// size to the writebuffer
{
	...
	assert(pOnReceiveChar != NULL);
	m_OnReceiveChar = pOnReceiveChar;
...
void CSerialPort::ReceiveChar(CSerialPort* port, COMSTAT comstat)
{
	...
	{ 
		...
		(*m_OnReceiveChar)(RXBuff,port->m_nPortNr);
