...
#if !defined(_RM_KS_INCL_)
#define _RM_KS_INCL_

#if defined(_NTDDK_)

#else
#ifdef DEFINE_LONG_PTR
	typedef unsigned __int64 ULONG_PTR, *PULONG_PTR;
	typedef __int64 LONG_PTR, *PLONG_PTR;
#endif // DEFINE_LONG_PTR
#endif // _NTDDK_
...
#define FILE_DEVICE_RM    0x00008200U

#define IOCTL_KS_PROPERTY              CTL_CODE(FILE_DEVICE_RM, 0x000, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_KS_ENABLE_EVENT          CTL_CODE(FILE_DEVICE_RM, 0x001, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_KS_DISABLE_EVENT         CTL_CODE(FILE_DEVICE_RM, 0x002, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_KS_METHOD                CTL_CODE(FILE_DEVICE_RM, 0x003, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_KS_WRITE_STREAM          CTL_CODE(FILE_DEVICE_RM, 0x004, METHOD_NEITHER, FILE_WRITE_ACCESS)
#define IOCTL_KS_READ_STREAM           CTL_CODE(FILE_DEVICE_RM, 0x005, METHOD_NEITHER, FILE_READ_ACCESS)
#define IOCTL_KS_RESET_STATE           CTL_CODE(FILE_DEVICE_RM, 0x006, METHOD_NEITHER, FILE_ANY_ACCESS)
...
#define RMPIN_DATAFLOW_IN		KSPIN_DATAFLOW_IN
#define RMPROPSETID_Pin			KSPROPSETID_Pin
#define RMPROPERTY_PIN_CTYPES	KSPROPERTY_PIN_CTYPES
#define RMPROPERTY_TYPE_GET		KSPROPERTY_TYPE_GET
#define RMPROPERTY_TYPE_SET		KSPROPERTY_TYPE_SET
#define RMPROPERTY_PIN_NAME		KSPROPERTY_PIN_NAME
#define RMPROPERTY_PIN_DATAFLOW	KSPROPERTY_PIN_DATAFLOW
#define RMPROPERTY_TYPE_BASICSUPPORT	KSPROPERTY_TYPE_BASICSUPPORT
#define RMPROPSETID_Clock 		KSPROPSETID_Clock
#define RMPROPERTY_CLOCK_PHYSICALTIME KSPROPERTY_CLOCK_PHYSICALTIME
#define IOCTL_RM_PROPERTY		IOCTL_KS_PROPERTY
#define IOCTL_RM_WRITE_STREAM	IOCTL_KS_WRITE_STREAM
#define IOCTL_RM_READ_STREAM	IOCTL_KS_READ_STREAM
#define IOCTL_RM_RESET_STATE	IOCTL_KS_RESET_STATE
//#define RMSTATE_STOP			KSSTATE_STOP
//#define RMSTATE_RUN			KSSTATE_RUN
//#define RMSTATE_PAUSE			KSSTATE_PAUSE
#define RMDATAFORMAT_ATTRIBUTES	KSDATAFORMAT_ATTRIBUTES
#define RMDATAFORMAT_TEMPORAL_COMPRESSION	KSDATAFORMAT_TEMPORAL_COMPRESSION
#define RMPROPERTY_PIN_PROPOSEDATAFORMAT	KSPROPERTY_PIN_PROPOSEDATAFORMAT
#define RMPROPERTY_PIN_DATARANGES			KSPROPERTY_PIN_DATARANGES
#define RMPROPSETID_Connection		KSPROPSETID_Connection
#define RMPROPERTY_CONNECTION_DATAFORMAT	KSPROPERTY_CONNECTION_DATAFORMAT
#define RMRESET_BEGIN			KSRESET_BEGIN
#define RMRESET_END				KSRESET_END
#define RMPROPERTY_CONNECTION_STATE			KSPROPERTY_CONNECTION_STATE
#define RMSTREAM_HEADER_OPTIONSF_TIMEVALID	KSSTREAM_HEADER_OPTIONSF_TIMEVALID
#define RMSTREAM_HEADER_OPTIONSF_TIMEDISCONTINUITY	KSSTREAM_HEADER_OPTIONSF_TIMEDISCONTINUITY




//typedef KSSTATE				RMSTATE;
typedef KSPIN_DATAFLOW		RMPIN_DATAFLOW;
typedef KSP_PIN				RMP_PIN;
