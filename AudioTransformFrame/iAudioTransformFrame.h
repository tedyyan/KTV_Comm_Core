...
DEFINE_GUID(IID_IAudioTransformFrame, 
0x4932165b, 0xc95d, 0x4de4, 0xbf, 0x7b, 0x93, 0xbe, 0x2e, 0xc6, 0xb, 0x83);

DECLARE_INTERFACE_(IAudioTransformFrame, IUnknown)
{
    STDMETHOD(get_AudioTransformFrame) (THIS_
                AudioTransformFrameParameters *irp
             ) PURE;

    STDMETHOD(put_AudioTransformFrame) (THIS_
                AudioTransformFrameParameters irp
             ) PURE;
};
