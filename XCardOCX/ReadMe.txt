========================================================================
		ActiveX Control DLL : XCARDOCX
========================================================================

ControlWizard has created this project for your XCARDOCX ActiveX Control
...
that make up your XCARDOCX ActiveX Control DLL.
...
XCardOCXCtl.h
	This file contains the declaration of the CXCardOCXCtrl C++ class.

XCardOCXCtl.cpp
	This file contains the implementation of the CXCardOCXCtrl C++ class.

XCardOCXPpg.h
	This file contains the declaration of the CXCardOCXPropPage C++ class.

XCardOCXPpg.cpp
	This file contains the implementation of the CXCardOCXPropPage C++ class.

XCardOCXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CXCardOCXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file XCardOCX.rc.
