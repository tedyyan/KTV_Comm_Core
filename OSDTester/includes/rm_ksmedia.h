...
# error RM_KS.H must be included before RM_KSMEDIA.H
# endif // !defined(_RM_KS_INCL_)

#if !defined(_RM_KSMEDIA_)
#define _RM_KSMEDIA_
...
typedef enum {
    KSPROPERTY_OVERLAY_INTERESTS,
    KSPROPERTY_OVERLAY_CLIPLIST,
    KSPROPERTY_OVERLAY_PALETTE,
    KSPROPERTY_OVERLAY_COLORKEY,
    KSPROPERTY_OVERLAY_VIDEOPOSITION,
    KSPROPERTY_OVERLAY_DISPLAYCHANGE,
    KSPROPERTY_OVERLAY_COLORREF
} KSPROPERTY_OVERLAY;
